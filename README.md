...
> **IMPORTANT:** To use these credentials, you must first populate your database by running the seed script:
> ```bash
> cd backend
> npm run seed:demo
> ```
...
### 🛡️ Security Staff (Frontdesk/Check-in)
```text
...
### 🎟️ Sample Visitor Pass
A test visitor pass is also generated by the seed script:
* **Pass ID:** `PASS-DEMO-001`
