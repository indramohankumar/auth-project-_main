...
function Dashboard() {
  ...
  const QUICK_ACTIONS = [
    ...
    { label: "Check In / Out", path: "/check", bg: "bg-emerald-600 hover:bg-emerald-700" },
  ];
                ...
                {recentVisitors.map((v) => (
                  ...
                  >
                    {v.photoUrl ? (
                      ...
                      <div className="w-9 h-9 rounded-full bg-blue-500/15 text-blue-200 border border-blue-500/20 flex items-center justify-center text-sm font-extrabold flex-shrink-0">
                    ...
                    <span className="text-xs font-semibold text-white/35 flex-shrink-0 tabular-nums">
                      {timeAgo(v.createdAt)}
                    </span>
                  </li>
                ))}
              ...
              <ul className="divide-y divide-white/5">
                {recentAppointments.map((a) => (
                  <li
                    ...
                    className="flex items-center gap-3 px-5 py-3 hover:bg-white/5 transition-colors"
                  >
                    <div className="w-9 h-9 rounded-full bg-indigo-500/15 text-indigo-200 border border-indigo-500/20 flex items-center justify-center flex-shrink-0">
                      <svg
                        className="w-4 h-4"
                        fill="none"
                        stroke="currentColor"
